...
export default class News extends Component {
  ...
  async updateNews (){
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=295d14d8acf949aebefe464dff3137ae&page=${this.state.page}&pageSize=${this.props.pageSize}`;
